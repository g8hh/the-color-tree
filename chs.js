...
var cnItems = {
    ...
    "m - reset for magenta points": "m - 重置得到品红色点",
    "r - reset for red points": "r - 重置得到红色点",
    "y - reset for yellow points": "y - 重置得到黄色点",
    "white points": "白色点",
    "Infinity Power": "无限力量",
    ...
    "A1 infinity upgrade is better.": "A1无限升级更好。",
    "Add 5 bouns 3rd row colors effect.": "添加 5 个额外的第 3 行颜色效果。",
    "1st & 4th magenta upgrade is better.": "第 1 个和第 4 个品红色升级更好。",
    "2nd green upgrade is better.": "第二个绿色升级更好。",
    "2nd Red & Blue upgrade formula is better.": "第二个红色蓝色升级公式更好。",
    "Blue points boost blue effect.": "蓝色点增强蓝色效果。",
    "Green powers boost infinity powers gain.": "绿色力量提升无限力量增益。",
    "Infinity points boost magenta effect.": "无限点增强洋红色效果。",
    "Infinity points boost point generation.": "无限点提升点数生成。",
    "Infinity powers boost 2nd row colors effect.": "无限力量提升了第二行的颜色效果。",
    "Infinity powers boost green effects.": "无限力量增强绿色效果。",
    "Infinity powers boost white points gain.": "无限力量提高白色点增益。",
    "Keep white upgrades on reset for pre-infinity.": "重置时保留白色升级在无限前。",
    "Raise white points gain by 1.15.": "将白色点增益提高 1.15。",
    "Red points boost red effect.": "红色点增强红色效果。",
    "White points boost point generation.": "白色点增强点数生成。",
    "": "",
    "": "",
    "": "",
    "": "",
